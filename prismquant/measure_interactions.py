...
from prismquant.allocator import (
...
from prismquant.calibrate_allocator import (
...
from prismquant.interaction_refine import (
...
def _measure_recipe(
    ...
    try:
        ...
        for handle in hook_handles:
            handle.remove()
        from prismquant.calibrate_allocator import restore_in_place
