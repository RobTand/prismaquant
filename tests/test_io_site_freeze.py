...
ALLOWED: dict[str, tuple[int, str]] = {
    ...
    "prismaquant/joint_adjoint_checkpoints.py::GpuPowerSampler.start": (1, "sampler"),
    ...
    "prismaquant/measure_quant_cost.py::start_mem_watchdog": (1, "sampler"),
    "prismaquant/nvfp4_cb_formats.py::_ldlq_reassign_fields_3d_batched": (1, "compute"),
    "prismaquant/nvfp4_cb_formats.py::_ldlq_reassign_fields_3d_threaded": (1, "compute"),
    ...
    "prismaquant/stage_b_workspace_profile.py::HostPeakSampler.__init__": (1, "sampler"),
    "prismaquant/stage_b_workspace_profile.py::_MemAvailableFloor.__init__": (1, "sampler"),
    ...
    "tools/chain_roll_bench.py::_MemoryWatch.__init__": (1, "tool"),
    "tools/dsv4_afast_burn.py::_replay": (1, "tool"),
    "tools/dsv4_afast_campaign.py::RSSGuard.__init__": (1, "tool"),
    "tools/dsv4_afast_campaign.py::_activation_replay": (1, "tool"),
    "tools/dsv4_minchain_pilot.py::_evaluate_all": (1, "tool"),
    "tools/dsv4_minchain_pilot.py::_refine_all": (1, "tool"),
    "tools/measure_wire_rehash_readers.py::main": (1, "tool"),
    "tools/nvfp4_served_qdq_bench.py::PowerSampler.__init__": (1, "tool"),
    "tools/pwc_window_load_bench.py::_PowerSampler (subclass)": (1, "tool"),
    "tools/render_window_bench.py::_Power.__init__": (1, "tool"),
    "tools/staged_exact_read_bench.py::MemcgPeaks.__enter__": (1, "tool"),
