...
def launch_argv(cwd,environ,affinity,args):
 ...
 env={'PRISMAQUANT_CONTAINER_CONTENT_SHA256':CONTENT,'PYTHONPATH':f'/pq:{PIN}/src','TESSERA_REPO':PIN,'OMP_NUM_THREADS':'1','MKL_NUM_THREADS':'1','OPENBLAS_NUM_THREADS':'1','PRISMAQUANT_PROD_ACT_SCALES':'0','PRISMAQUANT_DEV_MODE':'1','PRISMAQUANT_TMPDIR':'/tmp/prismaquant','TMPDIR':'/tmp','HF_HOME':'/tmp/huggingface','XDG_CACHE_HOME':'/tmp/cache','TRITON_CACHE_DIR':'/tmp/triton','TORCHINDUCTOR_COMPILE_THREADS':'1','MAX_JOBS':'1'}
