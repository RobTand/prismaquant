...
out=Path('/mnt/shared/tessera-measurements/glm-campaign-takeover-20260913/t4-reuse-20260922/render-paths.json');out.write_text(json.dumps(summary,sort_keys=True)+'\n');print(json.dumps({k:v for k,v in summary.items() if k!='rows'}))
